...
// Get from console
// =================================================
#define AWS_IOT_MQTT_HOST              "a2g4kcwiyy0rle.iot.us-west-2.amazonaws.com" ///< Customer specific MQTT HOST. The same will be used for Thing Shadow
...
#define AWS_IOT_MY_THING_NAME 		   "RPi-Gateway" ///< Thing Name of the Shadow this device is associated with
#define AWS_IOT_ROOT_CA_FILENAME       "VeriSign-Class 3-Public-Primary-Certification-Authority-G5.pem" ///< Root CA file name
#define AWS_IOT_CERTIFICATE_FILENAME   "fd5f1c490d-certificate.pem.crt" ///< device signed certificate file name
#define AWS_IOT_PRIVATE_KEY_FILENAME   "fd5f1c490d-private.pem.key" ///< Device private key filename
// =================================================
